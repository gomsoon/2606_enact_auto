...
This slice does not define Bag-aware `union`, `difference`, `intersection`, or aggregate `UNION`. It also does not change collection printing or introduce dot-method collection syntax.
