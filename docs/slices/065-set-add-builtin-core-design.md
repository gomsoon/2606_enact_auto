...
This slice does not change `insert`, does not add Bag-specific `add`, and does not introduce dot-method collection syntax. Set `UNION`, Bag multiplicity semantics, and custom collection printing remain deferred.
